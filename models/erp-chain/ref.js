...
module.exports = function (options, table_prefix) {
    ...
    //---------------------------读取本目录其它model文件--------------------------------------------
    //系统表
    var branch = sequelize.import('./branch.js');
    var s_user_role_r = sequelize.import('./s_user_role_r.js');
    var card = sequelize.import('./card.js');
    var employee = sequelize.import('./employee.js');
    var s_role = sequelize.import('./s_role.js');
    var vip = sequelize.import('./vip.js');
    var tmp_sale_carry_over = sequelize.import('./tmp_sale_carry_over.js');
    var sale = sequelize.import('./sale.js');
    var vip_trade_history = sequelize.import('./vip_trade_history.js');
    //------------------------------------END------------------------------------------------------
    ...
    //----------------------------------表模型加入全局----------------------------------------------
    //系统表
    global[table_prefix+"_branch"] = branch;
    global[table_prefix+"_s_user_role_r"] = s_user_role_r;
    global[table_prefix+"_card"] = card;
    global[table_prefix+"_employee"] = employee;
    global[table_prefix+"_s_role"] = s_role;
