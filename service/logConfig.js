...
exports.configure = function () {
    log4js.configure(path.join(__dirname, "..", "config", "logConfig", "log4js.json"));
};
...
exports.useLog = function () {
    var HTTP_LOG_FORMAT_DEV = '[:remote-addr][:method][:status][:response-time ms][:url]';
    return log4js.connectLogger(log4js.getLogger("request"), {level: log4js.levels.INFO, format: HTTP_LOG_FORMAT_DEV});
};